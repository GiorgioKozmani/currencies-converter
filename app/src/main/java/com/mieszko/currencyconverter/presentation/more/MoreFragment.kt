...
class MoreFragment : Fragment(R.layout.more_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupAdapter(
            view, listOf(
                MoreListItem.Builder(requireContext()).setTitle(R.string.privacy_policy_title).setDescription(R.string.privacy_policy_desc).setIcon(R.drawable.outline_policy_black_48).doOnClick {}.build(),
                MoreListItem.Builder(requireContext()).setTitle(R.string.leave_feedback_title).setDescription(R.string.leave_feedback_desc).setIcon(R.drawable.outline_wb_incandescent_black_48).doOnClick { EmailHelper.openFeedbackEmail(requireContext()) }.build(),
                ...
                MoreListItem.Builder(requireContext()).setTitle(R.string.rate_app_title).setDescription(R.string.rate_app_description).setIcon(R.drawable.outline_thumbs_up_down_black_48).doOnClick {  }.build(),
                MoreListItem.Builder(requireContext()).setTitle(R.string.about_title).setDescription(R.string.about_desc).setIcon(R.drawable.outline_emoji_people_black_48).doOnClick {}.build()
            )
        )
    }
